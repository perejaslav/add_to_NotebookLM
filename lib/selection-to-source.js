// Selection-to-Source module for Add to NotebookLM
...
const SelectionToSource = {
  ...
  STRINGS: {
    en: {
      menuTitle: 'Add selection to NotebookLM',
      titlePrefix: 'Selection',
      notifySuccess: 'Selection added to NotebookLM',
      notifyTruncated: 'Selection added to NotebookLM (truncated)',
      errNoNotebook: 'No notebook selected. Open Add to NotebookLM and choose a notebook.',
      errTooShort: 'Selection is too short (minimum 20 characters).',
      errEmpty: 'Selection is empty.',
      errAuth: 'Please login to NotebookLM first.',
    ...
    ru: {
      menuTitle: 'Добавить выделение в NotebookLM',
      titlePrefix: 'Выделение',
      notifySuccess: 'Выделение добавлено в NotebookLM',
      notifyTruncated: 'Выделение добавлено в NotebookLM (обрезано)',
      errNoNotebook: 'Нотбук не выбран. Откройте Add to NotebookLM и выберите нотбук.',
      errTooShort: 'Выделение слишком короткое (минимум 20 символов).',
      errEmpty: 'Выделение пустое.',
      errAuth: 'Сначала войдите в NotebookLM.',
...
(function selfCheck() {
  ...
  assert(S.getMenuTitle('en') === 'Add selection to NotebookLM', 'menu en');
  assert(S.getMenuTitle('ru') === 'Добавить выделение в NotebookLM', 'menu ru');
  assert(S.getNotificationMessage('en', 'success') === 'Selection added to NotebookLM', 'notify en');
  assert(S.getNotificationMessage('ru', 'truncated') === 'Выделение добавлено в NotebookLM (обрезано)', 'notify ru');
